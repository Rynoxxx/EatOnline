...
{$url}index.php?controller=registrazione&task=attivazione&numero_tel={$numero}&codice_attivazione={$codice_attivazione}
...
Il tuo numero &egrave;: {$numero}
Il tuo codice di attivazione e': {$codice_attivazione}


In caso di problemi con la registrazione contatta un membro dello staff: {$email_webmaster}
